...
async function applyBaseline(owner, entry, seeds, projections, botToken) {
  ...
  const pr = await call('POST', `/repos/${owner}/${name}/pulls`, botToken, {
    ...
    body:
      ...
      `[repo-baseline-files SOP](https://github.com/${owner}/dev-steward/blob/main/docs/sop/repo-baseline-files.md) ` +
      `and [ENG-0038](https://github.com/${owner}/dev-steward/blob/main/docs/decisions/ENG-0038-governance-reconciler.md). ` +
