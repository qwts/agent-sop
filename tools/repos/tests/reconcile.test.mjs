...
test('the baseline agent context maps governed repos to shared guidance and skills', () => {
  ...
  assert.match(baseline, /https:\/\/github\.com\/qwts\/agent-sop\/blob\/main\/docs\/reference\/agent-conventions\.md/);
  assert.match(baseline, /https:\/\/github\.com\/qwts\/agent-sop\/blob\/[0-9a-f]{40}\/skills\/README\.md/);
  assert.match(baseline, /https:\/\/github\.com\/qwts\/agent-sop\/blob\/main\/docs\/sop\/README\.md/);
  assert.match(baseline, /https:\/\/github\.com\/qwts\/agent-sop\/blob\/main\/docs\/decisions\/README\.md/);
