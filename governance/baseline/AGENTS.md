...
[ENG-0006](https://github.com/qwts/dev-steward/blob/main/docs/decisions/ENG-0006-agentic-primitives-governance.md).
...
[org-wide agent conventions](https://github.com/qwts/dev-steward/blob/main/docs/reference/agent-conventions.md).
Before creating or copying a repo-local skill, consult the reviewed
[shared agent skills](https://github.com/qwts/dev-steward/blob/74e775ef23d8e7d8f8e693ccc2329f430978c096/skills/README.md)
...
[dev-steward](https://github.com/qwts/dev-steward) — its
[shared SOPs](https://github.com/qwts/dev-steward/blob/main/docs/sop/README.md)
and [engineering decisions](https://github.com/qwts/dev-steward/blob/main/docs/decisions/README.md)
apply here by default
([ENG-0008](https://github.com/qwts/dev-steward/blob/main/docs/decisions/ENG-0008-shared-sop-inheritance.md):
